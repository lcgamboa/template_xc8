...
SOURCEFILES_QUOTED_IF_SPACED=teclado.c serial.c rtc_r.c pwm.c adc.c config.c delay.c display7s.c eeprom.c eeprom_ext.c lcd.c itoa.c i2c.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/teclado.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/rtc_r.p1 ${OBJECTDIR}/pwm.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/config.p1 ${OBJECTDIR}/delay.p1 ${OBJECTDIR}/display7s.p1 ${OBJECTDIR}/eeprom.p1 ${OBJECTDIR}/eeprom_ext.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/itoa.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/teclado.p1.d ${OBJECTDIR}/serial.p1.d ${OBJECTDIR}/rtc_r.p1.d ${OBJECTDIR}/pwm.p1.d ${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/config.p1.d ${OBJECTDIR}/delay.p1.d ${OBJECTDIR}/display7s.p1.d ${OBJECTDIR}/eeprom.p1.d ${OBJECTDIR}/eeprom_ext.p1.d ${OBJECTDIR}/lcd.p1.d ${OBJECTDIR}/itoa.p1.d ${OBJECTDIR}/i2c.p1.d ${OBJECTDIR}/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/teclado.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/rtc_r.p1 ${OBJECTDIR}/pwm.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/config.p1 ${OBJECTDIR}/delay.p1 ${OBJECTDIR}/display7s.p1 ${OBJECTDIR}/eeprom.p1 ${OBJECTDIR}/eeprom_ext.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/itoa.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/main.p1

# Source Files
SOURCEFILES=teclado.c serial.c rtc_r.c pwm.c adc.c config.c delay.c display7s.c eeprom.c eeprom_ext.c lcd.c itoa.c i2c.c main.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/template.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/template.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fshort-double -fshort-float -memi=wordwrite -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"bibliotecas.X" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c90 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/template.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
